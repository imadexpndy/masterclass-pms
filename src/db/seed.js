...
export async function seedDatabase() {
    ...
    const items = [
        // ===== ENTRÉES MAROCAINES =====
        { id: uid(), categoryId: 'cat-entrees-marocaines', name: 'Harira Marocaine - Soupe', nameAr: 'حريرة مغربية', price: 50, description: 'Dattes et chbbakiya, œuf dur', available: true, stockQty: 999, image: '' },
        { id: uid(), categoryId: 'cat-entrees-marocaines', name: 'Assortiment de salades marocaines', nameAr: 'تشكيلة سلطات مغربية', price: 70, description: 'Courgettes, Tomates poivron, Taktouka, Hommous, Zaalouk, Carottes marinées, Tomates confites, Potiron confit, Oignons confits au raisin, Poivrons marinés, Epinards', available: true, stockQty: 999, image: '' },
        { id: uid(), categoryId: 'cat-entrees-marocaines', name: 'Assortiment de 6 Briwates', nameAr: 'تشكيلة 6 بريوات', price: 90, description: 'Epinards, poulet, légumes et viande hachée', available: true, stockQty: 999, image: '' },
        { id: uid(), categoryId: 'cat-entrees-marocaines', name: 'Assortiment de 6 cigares', nameAr: 'تشكيلة 6 سيكار', price: 90, description: 'Épinards, poulet, légumes', available: true, stockQty: 999, image: '' },
        { id: uid(), categoryId: 'cat-entrees-marocaines', name: 'Pastilla royale de poulet aux amandes', nameAr: 'بسطيلة ملكية بالدجاج واللوز', price: 90, description: '', available: true, stockQty: 999, image: '' },
        { id: uid(), categoryId: 'cat-entrees-marocaines', name: 'Pastilla fruits de mer', nameAr: 'بسطيلة فواكه البحر', price: 110, description: 'Pastilla farcie aux fruits de mer, poisson blanc et vermicelles', available: true, stockQty: 999, image: '' },

        // ===== ENTRÉES INTERNATIONALES =====
        { id: uid(), categoryId: 'cat-entrees-internationales', name: 'Salade Niçoise', nameAr: 'سلطة نيسواز', price: 60, description: 'Salade verte, poivron, tomate, thon, œufs, olives noires, carotte, pomme de terre', available: true, stockQty: 999, image: '' },
        { id: uid(), categoryId: 'cat-entrees-internationales', name: 'Avocado Salad', nameAr: 'سلطة أفوكادو', price: 70, description: 'Avocat, concombre, ognon, tomate, salade verte sauce pesto', available: true, stockQty: 999, image: '' },
        { id: uid(), categoryId: 'cat-entrees-internationales', name: 'Quinoa Salad', nameAr: 'سلطة كينوا', price: 80, description: 'Quinoa, poivron, mangue, maïs, thon, ognon, avocat', available: true, stockQty: 999, image: '' },
        { id: uid(), categoryId: 'cat-entrees-internationales', name: 'Quinoa aux légumes grillés', nameAr: 'كينوا بالخضر المشوية', price: 85, description: 'Quinoa, aubergine, carottes, courgettes, poivrons, sauce pesto, tomates cerises', available: true, stockQty: 999, image: '' },
        ...
        { id: uid(), categoryId: 'cat-table-marocaine', name: 'Tagine poulet olives citrons confits', nameAr: 'طاجين دجاج بالزيتون والحامض المصير', price: 100, description: 'Tagine de poulet aux olives, citrons confits et frites', available: true, stockQty: 999, image: '' },
        { id: uid(), categoryId: 'cat-table-marocaine', name: 'Tajine kefta aux œufs', nameAr: 'طاجين كفتة بالبيض', price: 120, description: 'Tajine kefta traditionnel aux œufs', available: true, stockQty: 999, image: '' },
        ...
        { id: uid(), categoryId: 'cat-table-marocaine', name: 'Couscous végétarien', nameAr: 'كسكس نباتي', price: 150, description: '', available: true, stockQty: 999, image: '' },
        { id: uid(), categoryId: 'cat-table-marocaine', name: 'Tajine agneau/bœuf pruneaux', nameAr: 'طاجين لحم بالبرقوق', price: 150, description: 'Tajine d\'agneau ou bœuf amandes grillées, pruneaux, sésame', available: true, stockQty: 999, image: '' },
        ...
        { id: uid(), categoryId: 'cat-table-marocaine', name: 'Couscous Royal', nameAr: 'كسكس رويال', price: 180, description: 'Couscous Royal aux légumes, poulet ou agneau ou bœuf avec raisins sec, amandes grillées et ognon caramélisés', available: true, stockQty: 999, image: '' },
        ...
        { id: uid(), categoryId: 'cat-table-internationale', name: 'Spaghetti / Penné / Tagliatelle', nameAr: 'سباغيتي / بيني / تاليتيلي', price: 90, description: 'Bolognaise, tomates cerises, herbes, ail et fromage, Champignon, poulet sauce blanche', available: true, stockQty: 999, image: '' },
        { id: uid(), categoryId: 'cat-table-internationale', name: 'Emincé poulet/bœuf sauce blanche', nameAr: 'شرائح دجاج/لحم بالصلصة البيضاء', price: 120, description: 'Emincé de poulet ou bœuf à la sauce blanche et champignons, avec accompagnement au choix : purée, légumes, frites, riz', available: true, stockQty: 999, image: '' },
        { id: uid(), categoryId: 'cat-table-internationale', name: 'Grillade mixte', nameAr: 'مشويات', price: 160, description: 'Grillade poulet, kefta, côtelettes ou mixte grillade, avec accompagnement au choix : purée, légumes, frites, riz', available: true, stockQty: 999, image: '' },
        ...
        { id: uid(), categoryId: 'cat-desserts', name: 'Salade de fruits de saison', nameAr: 'سلطة فواكه الموسم', price: 50, description: '', available: true, stockQty: 999, image: '' },
        { id: uid(), categoryId: 'cat-desserts', name: 'Crêpes Nutella', nameAr: 'كريب نوتيلا', price: 50, description: 'Crêpes au Nutella - banane ou fruits rouge', available: true, stockQty: 999, image: '' },
        ...
        { id: uid(), categoryId: 'cat-desserts', name: 'Tarte de fruits', nameAr: 'تارت الفواكه', price: 60, description: '', available: true, stockQty: 999, image: '' },
        { id: uid(), categoryId: 'cat-desserts', name: 'Crème brûlée', nameAr: 'كريم بروليه', price: 60, description: '', available: true, stockQty: 999, image: '' },
        ...
        { id: uid(), categoryId: 'cat-desserts', name: 'Panna cotta orange', nameAr: 'بنا كوتا بالبرتقال', price: 60, description: 'Panna cotta au coulis à l\'orange', available: true, stockQty: 999, image: '' },
        { id: uid(), categoryId: 'cat-desserts', name: 'Fondant au chocolat', nameAr: 'فوندان شوكولا', price: 70, description: 'Fondant au chocolat avec boule de glace vanille', available: true, stockQty: 999, image: '' },
        { id: uid(), categoryId: 'cat-desserts', name: 'Pastilla au lait (Jawhara)', nameAr: 'بسطيلة بالحليب (جوهرة)', price: 75, description: '', available: true, stockQty: 999, image: '' },

        // ===== MENUS / SET MENUS =====
        { id: uid(), categoryId: 'cat-menus', name: 'Le Traditionnel', nameAr: 'التقليدي', price: 250, description: 'Zaalouk, Salade tomate + Tagine poulet citrons confits, olives et frites + Oranges ou Salade de fruits', available: true, stockQty: 999, image: '' },
        { id: uid(), categoryId: 'cat-menus', name: 'La Kasbah', nameAr: 'القصبة', price: 300, description: '3 salades marocaines + Seffa Medfouna ou Tride beldi + Gâteaux marocains ou Poire à la cannelle', available: true, stockQty: 999, image: '' },
        { id: uid(), categoryId: 'cat-menus', name: 'Le Marrakchi', nameAr: 'المراكشي', price: 350, description: 'Briouates variés + Tangia Marrakchia ou Makfoul d\'Agneau + Oranges ou Pastilla au lait', available: true, stockQty: 999, image: '' },
        { id: uid(), categoryId: 'cat-menus', name: 'Royal Almisk', nameAr: 'رويال المسك', price: 400, description: 'Pastilla royale + Tajine agneau/bœuf ou Couscous Royal + Tarte de fruits ou Panna cotta', available: true, stockQty: 999, image: '' },
        ...
        // ===== BOISSONS =====
        { id: uid(), categoryId: 'cat-boissons', name: 'Eau minérale 50cl', nameAr: 'ماء معدني 50سل', price: 10, description: 'Eau mineral 50cl / Oulmes 50cl', available: true, stockQty: 999, image: '' },
        { id: uid(), categoryId: 'cat-boissons', name: 'Soda', nameAr: 'مشروب غازي', price: 20, description: 'Coca, Coca Zero, Sprite, Hawai, Pom\'s, Schweppes, Fanta orange, Fanta citron', available: true, stockQty: 999, image: '' },
        { id: uid(), categoryId: 'cat-boissons', name: 'Eau minérale 1L / Oulmes 75cl', nameAr: 'ماء معدني 1 لتر', price: 20, description: '', available: true, stockQty: 999, image: '' },
        ...
        { id: uid(), categoryId: 'cat-cocktails', name: 'Mocktail MAMOUNIA', nameAr: 'موكتيل المامونية', price: 50, description: 'Nespresso, sirop de fraise, citron, miel, cannelle', available: true, stockQty: 999, image: '' },
        ...
        { id: uid(), categoryId: 'cat-cocktails', name: 'Mocktail MACHWAR', nameAr: 'موكتيل المشور', price: 50, description: 'Citron, feuille de menthe, sirop de fraise, Sprite', available: true, stockQty: 999, image: '' },
