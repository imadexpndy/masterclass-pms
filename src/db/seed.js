...
export async function seedDatabase() {
    ...
    const items = [
        ...
        // ===== DRINKS =====
        { id: uid(), categoryId: 'cat-drinks', name: 'Café Noir', price: 12, description: '', available: true, stockQty: 999, image: 'https://images.unsplash.com/photo-1497935586351-b67a49e012bf?auto=format&fit=crop&w=500&q=60' },
        { id: uid(), categoryId: 'cat-drinks', name: 'Nexpresso', price: 15, description: '', available: true, stockQty: 999, image: 'https://images.unsplash.com/photo-1497935586351-b67a49e012bf?auto=format&fit=crop&w=500&q=60' },
        { id: uid(), categoryId: 'cat-drinks', name: 'Americano', price: 15, description: '', available: true, stockQty: 999, image: 'https://images.unsplash.com/photo-1497935586351-b67a49e012bf?auto=format&fit=crop&w=500&q=60' },
        { id: uid(), categoryId: 'cat-drinks', name: 'Cappuccino', price: 20, description: '', available: true, stockQty: 999, image: 'https://images.unsplash.com/photo-1572442388796-11668a67e569?auto=format&fit=crop&w=500&q=60' },
        { id: uid(), categoryId: 'cat-drinks', name: 'Nas Nas', price: 15, description: '', available: true, stockQty: 999, image: 'https://images.unsplash.com/photo-1572442388796-11668a67e569?auto=format&fit=crop&w=500&q=60' },
        { id: uid(), categoryId: 'cat-drinks', name: 'Café Crème', price: 15, description: '', available: true, stockQty: 999, image: 'https://images.unsplash.com/photo-1572442388796-11668a67e569?auto=format&fit=crop&w=500&q=60' },
        { id: uid(), categoryId: 'cat-drinks', name: 'Ice Café', price: 20, description: '', available: true, stockQty: 999, image: 'https://images.unsplash.com/photo-1461023058943-07fcbe16d735?auto=format&fit=crop&w=500&q=60' },
        { id: uid(), categoryId: 'cat-drinks', name: 'Chocolat Chaud', price: 15, description: '', available: true, stockQty: 999, image: 'https://images.unsplash.com/photo-1544787219-7f47ccb76574?auto=format&fit=crop&w=500&q=60' },
        { id: uid(), categoryId: 'cat-drinks', name: 'Lait Chaud', price: 12, description: '', available: true, stockQty: 999, image: 'https://images.unsplash.com/photo-1517487881594-2787fef5ebf7?auto=format&fit=crop&w=500&q=60' },
        ...
        { id: uid(), categoryId: 'cat-drinks', name: 'Verveine', price: 12, description: '', available: true, stockQty: 999, image: 'https://images.unsplash.com/photo-1576092768241-dec231879fc3?auto=format&fit=crop&w=500&q=60' },
        { id: uid(), categoryId: 'cat-drinks', name: 'Infusions', price: 15, description: '', available: true, stockQty: 999, image: 'https://images.unsplash.com/photo-1576092768241-dec231879fc3?auto=format&fit=crop&w=500&q=60' },
        { id: uid(), categoryId: 'cat-drinks', name: 'Soda', price: 10, description: '', available: true, stockQty: 999, image: 'https://images.unsplash.com/photo-1622483767028-3f66f32aef97?auto=format&fit=crop&w=500&q=60' },
        { id: uid(), categoryId: 'cat-drinks', name: 'Orangina', price: 12, description: '', available: true, stockQty: 999, image: 'https://images.unsplash.com/photo-1622483767028-3f66f32aef97?auto=format&fit=crop&w=500&q=60' },
        { id: uid(), categoryId: 'cat-drinks', name: 'Eau 33cl', price: 5, description: '', available: true, stockQty: 999, image: 'https://images.unsplash.com/photo-1564419320461-6870880221ad?auto=format&fit=crop&w=500&q=60' },
        { id: uid(), categoryId: 'cat-drinks', name: 'Eau 50cl', price: 8, description: '', available: true, stockQty: 999, image: 'https://images.unsplash.com/photo-1564419320461-6870880221ad?auto=format&fit=crop&w=500&q=60' },
        { id: uid(), categoryId: 'cat-drinks', name: 'Eau 1.5L', price: 12, description: '', available: true, stockQty: 999, image: 'https://images.unsplash.com/photo-1564419320461-6870880221ad?auto=format&fit=crop&w=500&q=60' },
        { id: uid(), categoryId: 'cat-drinks', name: 'Oulmes 50cl', price: 10, description: '', available: true, stockQty: 999, image: 'https://images.unsplash.com/photo-1564419320461-6870880221ad?auto=format&fit=crop&w=500&q=60' },
        { id: uid(), categoryId: 'cat-drinks', name: 'Oulmes 1.5L', price: 12, description: '', available: true, stockQty: 999, image: 'https://images.unsplash.com/photo-1564419320461-6870880221ad?auto=format&fit=crop&w=500&q=60' },
